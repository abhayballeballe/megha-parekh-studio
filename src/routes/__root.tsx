...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Megha Parekh · TRIKAAL — Tarot & Vastu, Mumbai" },
      { name: "description", content: "Megha Parekh (TRIKAAL) offers personal Tarot readings and Vastu consultations in Mumbai. Understand first. Then decide." },
      { name: "author", content: "Megha Parekh" },
      { property: "og:site_name", content: "Megha Parekh · TRIKAAL" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Newsreader:ital,opsz,wght@0,6..72,300;0,6..72,400;0,6..72,500;1,6..72,300;1,6..72,400&family=Manrope:wght@400;500;600;700&display=swap" },
    ],
    scripts: [{ type: "application/ld+json", children: JSON.stringify({ "@context": "https://schema.org", "@type": "ProfessionalService", name: "Megha Parekh · TRIKAAL", description: "Tarot readings and Vastu consultations offered as personal guidance by Megha Parekh, Mumbai.", areaServed: "Mumbai, India", telephone: "+919892350754", sameAs: ["https://www.instagram.com/trikaal.megha/"], address: { "@type": "PostalAddress", addressLocality: "Mumbai", addressCountry: "IN" } }) }],
  }),
...
function RootComponent() {
  ...
  return <QueryClientProvider client={queryClient}><a href="#main" className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[60] focus:bg-primary focus:px-4 focus:py-2 focus:text-primary-foreground">Skip to content</a><Header /><main id="main" className="min-h-screen"><Outlet /></main><Footer /><WhatsAppCTA /></QueryClientProvider>;
}
